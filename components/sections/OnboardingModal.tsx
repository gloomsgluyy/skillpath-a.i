...
export default function OnboardingModal() {
  ...
  const closeModal = () => {
    ...
    setTimeout(() => setData({ step: 1, pendidikan: '', archetype: '', roleInterests: [], jurusan: '', minat: '', displayName: '' }), 300);
  };
          ...
          {data.step === 5 && (
            ...
            >
              ...
              <p className="text-slate-500 text-xs sm:text-sm font-semibold leading-relaxed mb-5 max-w-xs">
                Masukkan namamu, lalu masuk dengan Google untuk melihat hasil AI.
              </p>
